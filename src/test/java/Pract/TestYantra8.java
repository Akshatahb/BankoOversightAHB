...
public class TestYantra8 {
	...
	public static void main(String[] args) throws Throwable {
		...
		List<WebElement> pricelist = driver.findElements(By.xpath("//div[@class='_4rR01T']//ancestor::div[@class='_3pLy-c row']//descendant::div[@class='col col-5-12 nlI3QM']//descendant::div[@class='_30jeq3 _1_WHN1']"));
		...
		for (int i = 0; i < pricelist.size(); i++)
		{
			...
			//wrireDataintoExcel("pricelist1", i, 0, name, amount);
			wrireDataintoExcel("pricelist1", i, 0, name, price);
